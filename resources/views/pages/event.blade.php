  ...
  <div class="main-container ace-save-state" id="main-container">
    ...
    <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
      ...
      <ul class="nav nav-list">
        ...
        <li class="">
          <a href="datapage.html" <!--class="dropdown-toggle" -->
          ...
          <div class="row">
            <div class="col-xs-12">
                    ...
                    <img class="eventimg" src="{{ $eve['event_thumbnail'] }}"/>
                      ...
                      <div class="tab-content">
                        ...
                        <div id="{{ "info" . $key }}" class="tab-pane">
                          ...
                          <p> <b>Total Distance [km]: {{ $eve['event_distance'] }}</b></p>
              ...
              {{-- <div class="col-sm-8">
                <div class="tabbable tabs-left">
                <h3> Event 2 </h3>
                <img class="eventimg" src="Event2.jpg"/>
                  <ul class="nav nav-tabs" id="myTab3">
                    <li class="active">
                      <a data-toggle="tab" href="#det2">
                        <i class="ace-icon fa fa-rocket bigger-120"></i>
                        Details
                      </a>
                    </li>
                  ...
                  <div class="tab-content">
                    <div id="det2" class="tab-pane in active">
                      <p>Ever want to enter a marathon with a costume on? Well, here's your chance! Why wait? Sign up now! </p>
                    </div>

                    <div id="info2" class="tab-pane">
                      <p> <b>Date:</b> 23/8/2019 </p>
                      <p> <b>Time:</b> 6 am - 3 pm </p>
                      <p> <b>Location:</b> Kuala Lumpur, Jalan Tun Razak</p>
                      <p> <b>Total Distance [km]: 6 km or 10 km</b></p>

                    </div>

                    <div id="cont1" class="tab-pane">
                      <p> Facebook: MRC Charity Run 2018 </p>
                      <p>	Twitter: @MRCCharity </p>
                    </div>
                  </div>
                </div>
              </div> <!-- /.col --> --}}
...
@section('view-styles')
  <link rel="stylesheet" href="{!! asset('css/eventpg.css') !!}" />
